...
const flowSteps = [
  ...
  { icon: BarChart3, title: "政策对比分析", tag: "做判断", link: NEW_COMPARE_ANALYSIS_PATH },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate("/policy-writing/drafting", {
                        state: {
                          policyTitle: topic.featured ? DATA_INDUSTRY_POLICY_TITLE : topic.title,
                        },
                      })
                    }
                  >
          ...
          <Card className="p-5 border border-border">
            ...
            <div className="grid grid-cols-1 gap-3">
              {[
                { icon: Wrench, title: "政策工具箱", desc: "常用政策编写工具集合", link: "/policy-writing/policy-toolbox" },
                { icon: Calculator, title: "政策测算", desc: "资金与效果预测模型", link: "/policy-writing/model-estimation" },
                { icon: Database, title: "我的素材库", desc: "历史政策文档归档管理", link: "/reserve-library" },
                { icon: BookOpen, title: "政策词典", desc: "可复用条款模板库", link: "/policy-writing/policy-dictionary" },
              ].map((item) => (
                <div
                  key={item.title}
