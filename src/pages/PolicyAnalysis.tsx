...
import { PolicyCompareAnalysisDetail } from "@/components/policy-analysis/PolicyCompareAnalysisDetail";
...
export default function PolicyAnalysis() {
  ...
  const taskName = searchParams.get("taskName") || "测试11";

  if (mode === "compare-new") {
    return <PolicyCompareAnalysisDetail taskName={taskName} isNew />;
  }

  if (mode === "compare") {
    return <PolicyCompareAnalysisDetail taskName={taskName} />;
  }

  return <PolicyAnalysisFlow />;
}

function PolicyAnalysisFlow() {
